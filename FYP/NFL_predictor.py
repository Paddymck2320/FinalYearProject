...
YEAR = 2021
WEEK = 18
URL = "http://www.espn.com/nfl/schedule/_/week/" + str(WEEK) + "/seasontype/2"
...
for game in games:
    ...
    if Ea > Eb:
        ...
        pass
    cache.append((diff, acname + " @ " + hcname + ": " + aname + " - " + str(100 * Eb) + "% | " + hname + " - " + str(
        100 * Ea) + "% | Diff - " + str(100 * diff) + "%"))
...
print("-------------------------------------")
print(colored("0%-20%", "cyan"), colored("20%-40%", "green"), colored("40%-60%", "yellow"),
      colored("60%-80%", "magenta"), colored("80%+", "red"))
print("-------------------------------------")
for i in cache:
    print(i[1])
